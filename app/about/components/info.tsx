export const Info = () => {
  return (
    <section className="">
      <div className="container w-full bg-[#E9F4FF] py-[50px] flex  justify-center flex-col items-center text-center">
        ...
        <div className="container flex justify-between">
          ...
          <div className="w-full max-w-[678px]">
            ...
            <p className="text-[#666666] text-[20px]">
              ...
              javobgarlikni o‘z zimmasiga olmaydi. <br /><br /> Saytda nashr qilingan maqola
              yuzasidan, uning muallifi va sayt tahririyatining fikri bir xil
              bo‘lmasligi mumkin. Shuningdek, sayt tahririyati o‘quvchilarining
              yuborgan xatlarining har biriga alohida javob yozish majburiyatini
              olmaydi.
            </p>
          </div>
        </div>
